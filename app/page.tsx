...
export default function Home() {
  return (
    <main className='h-screen w-full bg-slate-250 font-semibold text-black flex flex-col justify-center items-center gap-10'>
      <h1 className="text-6xl text-800">Dynamic Rounting</h1>
